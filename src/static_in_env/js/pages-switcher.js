...
var PageTransitions = (function($, options) {
    ...
    function init(options) {
        ...
        sectionsContainer.each(function() {
            if (location.hash === "") {$('section[data-id=' + pageStart + ']').addClass('pt-page-current')
                                        }
        })
        ...
        $(".lmpixels-arrow-right").click(function() {
            ...
            if (activeItem.is(':last-child')) {$('.site-main-menu li:first-child').children("a").click()
                                               }
        })
        ...
        $(".lmpixels-arrow-left").click(function() {
            ...
            if (activeItem.is(':first-child')) {$('.site-main-menu li:last-child').children("a").click()
                                                }
        })
    }
    ...
    function activeMenuItem(item) {
        ...
        if(navLink) {$('ul.site-main-menu li').removeClass('active')
    ...
    function ajaxLoader() {
        ...
        function hideContent() {$('#page-ajax-loaded').addClass('rotateOutDownRight closed')
                                $('body').removeClass('ajax-page-visible')
                                setTimeout(function(){$('#page-ajax-loaded.closed').html('')
        ...
        $(document)
                .on("click", ".site-main-menu .pt-trigger.ajax-page-load #ajax-page-close-button", function (e) { // Hide Ajax Loaded Page on Navigation cleck and Close button
                                                                                                   e.preventDefault()
                                                                                                   hideContent()
    ...
    function Animate($pageTrigger, gotoPage) {
        ...
        if (tempPageIndex != currentPageId) {
                ...
                $currentPage.addClass(outClass).on(animEndEventName, function() {$currentPage.off(animEndEventName)
                                                                                 endCurrentPage=true
                                                                                 if(endNextPage) {
                ...
                $nextPage.addClass(inClass).on(animEndEventName, function() {$nextPage.off(animEndEventName)
                                                                             endNextPage=true
                                                                             if(endCurrentPage) {
                    onEndAnimation($pageWrapper, $nextPage, $currentPage)
                    endNextPage=false
    ...
    function resetPage($nextPage, $currentPage) {$currentPage.attr('class', $currentPage.data('originalClassList'))
